...
Contributors: BonfireThemes
Author: BonfireThemes
Author URI: http://bonfirethemes.com/
Plugin URI: http://bonfirethemes.com/
Tags: sticky header wordpress, floating, header, scroll
Stable tag: trunk
...
1. Upload /simple-sticky-header-on-scroll/ to the /wp-content/plugins/ directory
2. Activate the plugin through the 'Plugins' screen in WordPress
3. Use the "Appearance->Customize->Simple Sticky Header on Scroll Plugin" screen to configure and customize the plugin
